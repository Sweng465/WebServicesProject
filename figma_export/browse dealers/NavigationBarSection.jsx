...
export const NavigationBarSection = () => {
  const navigationItems = [
    ...
    {
      label: "Auto Parts",
      position: { top: "41px", left: "616px" },
      width: "107px",
    },
    {
      label: "Sell Items",
      position: { top: "41px", left: "788px" },
      width: "96px",
    },
    { label: "About", position: { top: "41px", left: "941px" }, width: "62px" },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-0 left-0 w-[209px] h-[53px] rounded-[10px] shadow-[0px_4px_4px_#00000040] bg-[linear-gradient(101deg,rgba(7,36,111,1)_4%,rgba(14,70,213,1)_97%)] group-hover:shadow-[0px_6px_6px_#00000040] transition-shadow" />
      ...
      >
        <div className="absolute top-0 left-0 w-[163px] h-[53px] bg-white rounded-[10px] border border-solid border-black shadow-[0px_4px_4px_#00000040] group-hover:shadow-[0px_6px_6px_#00000040] transition-shadow" />
      ...
      {navigationItems.map((item, index) => (
        <button
          key={index}
          className="absolute hover:text-blue-600 transition-colors"
          style={{
        ...
        >
          <span className="[font-family:'Inter-Bold',Helvetica] font-bold text-black text-xl tracking-[0] leading-[normal]">
            {item.label}
          </span>
        </button>
      ))}
